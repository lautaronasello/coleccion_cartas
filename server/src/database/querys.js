const queries = {
  ...
  getTeams: 'SELECT equipo FROM equipos',
  getPositions: 'SELECT posicion FROM posiciones ',
  getRarities: 'SELECT rareza FROM rarezas',
  getSeries: 'SELECT serie FROM series',
};
